...
internal class Build : NukeBuild
{
    ...
    private const string prodViewsPath = "/DesktopModules/MyModule/resources/scripts/era-mymodule/";
    ...
    Target Swagger => _ => _
        ...
        .Executes(() =>
        {
            ...
            NSwagTasks.NSwagWebApiToOpenApi(c => c
                .AddAssembly(RootDirectory / "bin" / Configuration / "Eraware.Modules.MyModule.dll")
                .SetInfoTitle("Eraware My Module")
